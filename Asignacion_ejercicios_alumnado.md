...
| ------------------------------ | -------------------------- | --------- | -------------------------------------------------------------- |
| **Almendras Fuentes, Mariana** | malmfue942@g.educaand.es   | **2**     | Filtrado avanzado de productos con múltiples criterios         |
| **Cabello Bautista, Diego**    | dcabbau114@g.educaand.es   | **10**     | Análisis estadístico de usuarios agrupados por ciudad          |
| **Correa Ribeiro, Pablo**      | pcorrib@g.educaand.es      | **14**     | Enriquecimiento de pedidos con cálculos y unión de datos       |
...
| **Hernández Porcel, Abel**     | aherpor913@g.educaand.es   | **13**     | Gestión de etiquetas de productos con Set y filtrado           |
| **Lara Martínez, Antonio**     | alarmar231@g.educaand.es   | **15**     | Análisis de hobbies y compatibilidad entre usuarios con Set    |
...
| **Nieto Navarro, Raquel**      | rnienav431@g.educaand.es   | **8**    | Historial de navegación de productos con LocalStorage          |
| **Santiago Gil, Marco**        | msangil1811@g.educaand.es  | **11**    | Dashboard completo de usuario integrando todas las estructuras |
| **Cano Molina, Francisco**     | amorper416@g.educaand.es   | **3**     | Sistema de preferencias de usuario con LocalStorage            |
| **Oliver Liria,Alfonso**      | @g.educaand.es   | **5**    | Historial de navegación de productos con LocalStorage          |
| **Pérez Martín, Fernando**        | @g.educaand.es  | **1**    | Dashboard completo de usuario integrando todas las estructuras |
